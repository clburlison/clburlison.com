...
{% capture fig_img %}
![My Geektools results]({{ site.url }}{{ site.baseurl }}/images/2014-07-14/current_info.png)
{% endcapture %}

<figure>
  {{ fig_img | markdownify | remove: "<p>" | remove: "</p>" }}
  <figcaption>My Desktop Results.</figcaption>
</figure>
...
{% capture fig_img %}
![Eriks Results]({{ site.url }}{{ site.baseurl }}/images/2014-07-14/eriks_info.png)
{% endcapture %}

<figure>
  {{ fig_img | markdownify | remove: "<p>" | remove: "</p>" }}
  <figcaption>Erik's Original Desktop Results.</figcaption>
</figure>
