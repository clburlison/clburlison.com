  ...
  class YouTubeTag < Liquid::Tag
    ...
    def render(context)
      ...
      if @videoid
        ...
        video += %Q{<div class="bt-video-container" style="position:relative;padding-bottom:#{padding_bottom};padding-top:30px;height:0;overflow:hidden"><iframe width="#{@width}" height="#{@height}" src="https://www.youtube.com/embed/#{@videoid}?rel=0?wmode=opaque" frameborder="0" allowfullscreen></iframe></div>}
      else
